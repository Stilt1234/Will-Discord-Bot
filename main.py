...
async def on_message(message: discord.Message):
    ...
    if(message.guild != None):
        ...
        if(message.content.find("WILL") != -1 and will_emoji != None and will_cube_emoji != None):
            ...
            await message.channel.send(embed=discord.Embed(colour=discord.Colour.red(), title="Please upload will and will cube emojis.", timestamp=message.created_at))

        if(message.content.find("CIRB") != -1 and cirb_emoji != None):
            await message.add_reaction(cirb_emoji)
        elif(discord.utils.get(message.guild.emojis, name = "will") == None):
            await message.channel.send(embed=discord.Embed(colour=discord.Colour.red(), title="Please upload cirb emoji.", timestamp=message.created_at))
